...
import com.sunit.xwt.flowability.po.Flowability;
...
import com.sunit.xwt.suborders.po.Suborders;
import com.sunit.xwt.suborders.service.SubordersManager;
...
public class TaskListener implements ActivitiEventListener{  
	...
	@Autowired
	SubordersManager  subordersManager;
...
//				}
				...
				final String candidate =entity.getUserId();
				final String xwyMI =(String) runtimeService.getVariable(procId, "xwyMI") ;
